...
void setup()
{
    ...
    //Configure the acceleration sensor, use the default configuration, 4G ,200HZ
    ...
    // Enable acceleration sensor double-click trigger
    ...
    instance.sleep(WAKEUP_SRC_SENSOR);
