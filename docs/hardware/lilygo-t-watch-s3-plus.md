...
* This page lists the hardware specifications for the `LilyGO T-Watch-S3-Plus`.

```text
  ┌----------------------------- GPIO0: user button and download-mode button
  |                     ┌------- RESET
  |                     |        Press to reset the device; this button is not programmable
  V                     V
  /---------------------\
  |                     |
  |                     -
...
| Flash                 | 16 MB (QSPI)                                |
| PSRAM                 | 8 MB (OPI)                                  |
| GNSS                  | [u-blox MIA-M10Q][2] or [Quectel LS550G][12] |
| LoRa                  | [Semtech SX1262][3] or SX1280               |
| Accelerometer sensor  | [Bosch BMA423][4] or [Bosch BMA456][13]     |
...
[13]: https://www.bosch-sensortec.com/products/motion-sensors/accelerometers/bma456/ "BMA456"
...
* On revisions with **BOOT** and **RST** buttons on the case, BLDO1 supplies power to the GNSS module.
* On earlier revisions without these buttons, DC3 supplies power to the GNSS module.
* On the LS550G revision, enable both DC4 (850 mV) and BLDO1 (3300 mV) through the PMU before using GNSS.
...
> [!IMPORTANT]
> Use a charging current of 300 mA or less, and never exceed 400 mA. Excessive charging current can damage the battery.
...
* The T-Watch-S3-Plus touch controller has no reset pin connected. If the controller is put to sleep, touch input cannot be restored without restarting the device.

### Resources

* [Motherboard schematic](../../schematic/T_WATCH-S3%2025-03-24.pdf)
* [GNSS schematic](../../schematic/T-Watch-S3-Plus-GPS%20V1.0%202025-04-29.pdf)
